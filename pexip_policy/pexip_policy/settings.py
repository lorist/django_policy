"""
Django settings for pexip_policy project.
...
SECRET_KEY = 'django-insecure-vr785$8d0g$p_v5!+(s&j_yad^y1&y05f*c^c)@jkz0g0!=#h8'
...
ROOT_URLCONF = 'pexip_policy.urls'
...
WSGI_APPLICATION = 'pexip_policy.wsgi.application'
